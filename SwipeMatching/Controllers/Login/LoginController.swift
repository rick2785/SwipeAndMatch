...
//  SwipeMatching
//
//  Created by Hrabowskie, Rj on 3/12/19.
...
class LoginController: UIViewController {
    ...
    fileprivate let backToRegisterButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleBack), for: .touchUpOutside)
        return button
    }()
    ...
    fileprivate func setupGradientLayer() {
        ...
        let bottomColor = #colorLiteral(red: 0.8235294118, green: 0, blue: 0.3254901961, alpha: 1)
