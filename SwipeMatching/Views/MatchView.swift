...
//  SwipeMatching
//
//  Created by Hrabowskie, Rj on 3/24/19.
...
class MatchView: UIView {
    ...
    fileprivate func setupLayout() {
        ...
        sendMessageButton.anchor(top: currentUserImageView.bottomAnchor, leading: self.leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 32, left: 48, bottom: 0, right: 48), size: .init(width: 0, height: 60))
